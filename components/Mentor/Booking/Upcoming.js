          ...
          <div className="flex justify-center align-center bg-gray-50 mt-10">
            <div className=" bg-white text-center border border-b-2 rounded-2xl shadow-lg m-4 w-auto  md:w-5/6 lg:w-5/6">
              ...
              <div className="py-4 px-6 border-t border-gray-300 text-gray-600">
                ...
                <button className="flex justify-center items-center bg-white border-2 border-gray-900 hover:border-amber-400 hover:bg-amber-400 hover:text-white text-black  rounded-full mr-5 w-full md:w-1/4 lg:w-1/4">
                  ...
                  <button className="flex justify-center items-center bg-black hover:bg-amber-400 text-white rounded-full mr-5 w-full md:w-1/4 lg:w-1/4">
